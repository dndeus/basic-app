...
var sublime = function () {
    ...
    function initLinkTransition() {
        $(document).on("click touchstart", "a.transition", function (e) {
            e.preventDefault();
            e.stopPropagation();
    ...
    function initAccordion() {
        ...
        $(document).on("click touchstart", ".accordion > dt > a", function (e) {
            e.preventDefault();
            e.stopPropagation(); 
    ...
    function initBoxCollapse() {
        $(document).on("click touchstart", ".widget-collapsible", function (e) {
    ...
    function initBoxRefresh() {
        $(document).on("click touchstart", ".widget-refresh", function (e) {
    ...
    function initBoxRemove() {
        $(document).on("click touchstart", ".widget-remove", function (e) {
    ...
    function initToggleBoxed() {
        $(document).on("click touchstart", ".toggle-boxed", function (e) {
    ...
    function initToggleScroll() {
        $(document).on("click touchstart", ".toggle-scroll", function (e) {
